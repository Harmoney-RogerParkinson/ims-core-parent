 ...
 * @link {http://jandrewthompson.blogspot.co.nz/2009/10/how-to-generate-ddl-scripts-from.html}
 *
 */
public class SchemaGenerator
{
  ...
  {
    SchemaGenerator gen = new SchemaGenerator("com.harmoney.ims.core.instances");
