...
public class LoanAccountMessagingIT {
	
    private static final Logger log = LoggerFactory.getLogger(LoanAccountMessagingIT.class);
	...
	public void testSubscription() throws ConnectionException, InterruptedException {
		...
		MessageHandler messageHandler = messageHandlerMap.getMessageHandler("/topic/LOANACCOUNT");
